...
namespace ProjectAltis
{
    ...
    public class Log
    {
            ...
            [CallerFilePath] string sourceFilePath = "")
        {
...
#elif !DEBUG
            ravenClient.Environment = "PRODUCTION";
#endif
            ravenClient.Timeout = TimeSpan.FromSeconds(3);
            ...
            ravenClient.Tags.Add("net-version", ErrorReporter.Instance.NetVersion);
            ravenClient.Tags.Add("Windows-Version", ErrorReporter.Instance.WindowsVersion);
